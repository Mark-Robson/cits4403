...
class herbivore(creature):
    ...
    def __init__(self, foodlevel, xco, yco, newspeed, species_id, childSize,
                 healthySize, worldsize):
        super().__init__(foodlevel, xco, yco, newspeed, species_id,
                         childSize, healthySize)
